...
export default {
	...
	data(){
		return {
	        ...
	        navs: [
                {name: '主页', key: 0, url: '/'},
                {name: 'Demo', key: 1, url: '', child: [{name: '图形', key: 10, url: '/', child: [{name: 'Canvas', key: 110, url: '/canvas'}, {name: 'SVG', key: 111, url: '/'}]}, {name: 'D3-组件', key: 11, url: '/d3'},{name: 'ChartJS', key: 12, url: '/cjs'}, {name: '通用组件', key: 13, url: '/component'}]},
